...
import { selectServices } from 'store/selectors/user';
import { ActionSetSelectedService, ActionSetServices } from 'store/actions/user';
...
const headCells = [
  ...
  { id: 'groupsNum', numeric: true, disablePadding: false, label: 'Number of groups' },
...
export default function UserTable () {
  ...
  const [data, setData] = useStoreState(selectServices, ActionSetServices);
